...
class ProviderArchitectureTest(unittest.TestCase):
    ...
    def test_every_containerfile_has_local_image_metadata(self):
        ...
        self.assertTrue(containerfiles)
    ...
    def test_tracked_deployment_mappings_are_intentional(self):
        expected = {
            ...
            "containers/glance/glance-api/image.yaml": ["glanceAPIImage"],
    ...
    def test_c6_package_inputs_are_image_local_and_helper_free(self):
        expected = {
            ...
            "containers/glance/glance-api/source-package-map.txt": "glance glance\n",
