...
class BuildPreparedContextsTest(unittest.TestCase):
    ...
    def _create_contexts(self):
        for context in ("base", "watcher", "cyborg", "glance"):
    ...
    def _run(self, check=True, environment=None, targets=None):
        ...
        result = subprocess.run(
            [
                ...
                "build-parallel",
                targets
                or "watcher/watcher-base,cyborg/cyborg,cyborg/cyborg-agent",
            ],
            check=False,
            capture_output=True,
            text=True,
