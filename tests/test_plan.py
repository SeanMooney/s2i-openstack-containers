...
class PlanTest(unittest.TestCase):
    ...
    def test_direct_glance_plan_uses_prepared_source_and_tracked_mapping(self):
        self.input["images"] = []
        ...
        self.assertEqual("direct", result["selection"]["reason"])
        ...
        self.assertEqual(
            "glance glance\n",
            generated["glance/glance-api/source-package-map.effective.txt"][
                "content"
            ],
        )
        self.assertNotIn(
            "glance==",
            generated["glance/glance-api/requirements.lock.effective.master"][
                "content"
            ].lower(),
        )
