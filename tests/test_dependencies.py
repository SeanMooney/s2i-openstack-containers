...
class DependenciesTest(unittest.TestCase):
    ...
    def test_glance_dependency_selects_glance_api(self):
        project = "opendev.org/openstack/glance-store"
        self._project(project, "glance_store")

        affected, _resolved = dependencies.resolve_transitive(
            self.repo_root,
            self.workspace,
            self.projects,
            [project],
        ...
        self.assertEqual(["glance/glance-api"], affected[project])
